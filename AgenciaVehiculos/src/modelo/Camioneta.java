 ...
 * @author Edwar
 */
public class Camioneta extends Vehiculo implements InterfazAgencia{
    int cantidad;
    String ejes;
    String cilindraje;
    String marca;
    ...
    public Camioneta(String marca, String modelo, String placa, int cantidad, String ejes, String cilindraje, double precio) {
