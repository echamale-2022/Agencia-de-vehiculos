 ...
 * @author Edwar
 */
public class Moto extends Vehiculo implements InterfazAgencia{
    int cantidad;
    String ejes;
    String cilindraje;
    String marca;
    ...
    public Moto(String marca, String modelo, String placa, int cantidad, String ejes, String cilindraje, double precio) {
